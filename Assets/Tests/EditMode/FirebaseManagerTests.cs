...
public class FirebaseManagerTests
{
    ...
    {
        var prop = typeof(T).GetProperty(propertyName, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);
    ...
    public void OnAuthReceived_CalledTwice_OverwritesFirstAuth()
    {
        ...
        string json2 = BuildAuthJson("4321", "token_4321", "Spencer", "Bug_sphere");
